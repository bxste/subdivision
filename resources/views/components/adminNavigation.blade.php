                    ...
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('admin.showData')">
                                {{ __('Homeowner Records') }}
                            </x-dropdown-link>  
                            <x-dropdown-link :href="route('admin.import')">
                                {{ __('Imports') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('admin.waiverForm')">
                                {{ __('Waiver') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('admin.calendar')">
                            {{ __('Calendar') }}
                        </x-dropdown-link>
